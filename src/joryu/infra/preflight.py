...
_JORYU_JOB_RUNTIME_PATHS = frozenset(
    {
        "docker-compose.yml",
        "src/joryu/distill/pipeline.py",
        "src/joryu/infra/docker/delegate.py",
        "src/joryu/infra/docker/runtime.py",
        "src/joryu/persistence/stats.py",
        "src/joryu/infra/preflight.py",
        "src/joryu/core/paths.py",
        "src/joryu/vllm/base.py",
        "src/joryu/vllm/common.py",
        "src/joryu/vllm/factory.py",
        "src/joryu/vllm/inproc.py",
        "src/joryu/vllm/serve.py",
        "src/joryu/vllm/protocol.py",
        "src/joryu/vllm/limits.py",
        "src/joryu/vllm/probe.py",
