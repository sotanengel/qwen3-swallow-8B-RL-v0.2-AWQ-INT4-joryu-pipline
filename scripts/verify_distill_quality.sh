...
uv run pytest tests/test_distill_quality_regression.py tests/vllm/test_normalize.py \
  ...
  tests/bench/test_prompts.py tests/bench/test_throughput_harness.py tests/bench/test_quality_compare.py \
  tests/bench/test_report_module.py tests/bench/test_cli_bench_parser.py -q
